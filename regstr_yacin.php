...
<body style="background-image:url('img/shape-groupe-adaming-2.png'); background-repeat:no-repeat; background-size:1500px 950px;">
            ...
            <div class="container">
                ...
                <div class="columns is-centered is-3-widescreen">
                    ...
                    <form action="check_register.php" method="POST" class="box">
                        ...
                        <div class="field">
                            <input class="button is-success" type="submit" name="submit" value="S'inscrire" style="color:blueviolet;">
                        </div>
                        <p>Vous avez deja un compte ? <a href="login_yacin.php"> Connectez-vous ici !</a></p>
                    </form>
